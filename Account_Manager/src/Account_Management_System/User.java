...
public class User {
    public void show_account_details(){
        Account_info asif = new Account_info("Asif Ahmed Chowdhury", "01766680017");
        Account_info safiyah = new Account_info("Safiyah Sultana", "01766610085");
